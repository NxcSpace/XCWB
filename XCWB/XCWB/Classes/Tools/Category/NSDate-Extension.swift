...
extension NSDate {
    class func createDateString(createAtStr : String) -> String {
       ...
       // let cmps = calendar.dateComponents(from: createDate, to: nowDate as Date, options: [])
        
        let cmps = calendar.dateComponents([Calendar.Component.year,Calendar.Component.month,Calendar.Component.day], from: createDate, to: nowDate as Date)
